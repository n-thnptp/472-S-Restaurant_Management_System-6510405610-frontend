...
```env
NEXT_PUBLIC_SERVER_API_URL=http://472-s-restaurant_management_system-6510405610-backend-laravel.test-1   # for server components
...
NEXTAUTH_URL=http://472-s-restaurant_management_system-6510405610-backend-laravel.test-1                 # for next auth dependencies (backend)
